...
// idemo vidjeti kako možemo zamjenitit postojeće elemente

// 1. koristeći replace metodu

function zamijeniZadatak () {
    const zadatak = document.querySelector
 ("li:first-child");
 const li = document.createElement ("li");
 li.innerText = "Zamijenili smo prvi zadatka";
...
function zamijeniTreciZadatak () {
    ...
    lista.forEach ((zadatak, kljuc) => {
        if(kljuc === 2) {
            zadatak.outerHTML = "<li>Zamijenili smo i ovaj zadatak koristeći forEach metodu i if petlju unutar nje";
        };
    });
};
