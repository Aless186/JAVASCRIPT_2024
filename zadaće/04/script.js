...
// testni podaci: račun 125, račun 555, račun 44
...
const marko = {
    ...
    visina: 1.69,
    calcITM() {
        this.itm = Math.round (this.težina / this.visina ** 2);
        return this.itm
    },
};
const Josip = {
...
if  (marko.itm > Josip.itm) {
    console.log(`${marko.ime}-ov ITM od ${marko.itm} je veći od ${Josip.ime}-ovog ITM-a od ${Josip.itm}.`);
} else {
    console.log(`${Josip.ime}-ov ITM od ${Josip.itm} je veći od ${marko.ime}-ovog ITM-a od ${marko.itm}.`);
};
...
Za dio sa zbrajanjem krenite sa kreiranjem varijable sum koja kreće sa početnom vrijednosti 0. U svakoj iteraciji dodajte trenutnu vrijednost liste u sum varijablu. 
*/
...
// kreiranje praznih listi koje ćemo popuniti for petljom
let napojnica2 = [];
let ukupno = [];
