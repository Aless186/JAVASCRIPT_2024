...
/* 
HyperText Transfer Protocol je protokl za slanje i primanje podataka na webu. Zahtjev inicijalizirate vi (klijent), a server će reagirati sa odgovorom. Odgovor može sadržavati HTML/CSS/JS fileove, slike ili druge resurse kao što su podaci u XML ili JSON obliku.

Najčešće dohvaćamo podatke i ispisujemo ih putem DOM manipulacije, ili updateamo/brišemo određene podatke.

Imamo GET, POST, PUT&PATCH, DELETE zahtjeve
...
404 - zahtjev za nečim što ne postoji (server se ne može naći)

500 - greška na serveru

Možete se igrati sa statusima ovdje: https://httpstat.us/ 

XMLHttpRequest je objekt ugrađen u našem browseru koji nam omogućava da radimo zahtjeve prema serveru bez refresha stranice. To nam omogućava dinamičko ponašanje stranice.
*/
...
// open metoda na našem XMLHttpRequest inicijalizira HTTP zahtjev i zaprima 2 parametra, metodu i adresu

xhr.open(metoda, url);

// Nakon inicijaliziranja HTTP zahtjeva možemo sa event hadlerom na našem objektu koji se zove onreadystatechanfe upravljati našim readystate svojstvom. ReadyState sadrži stanje u kojem se naš XMLHttpRequest klijent nalazi...
